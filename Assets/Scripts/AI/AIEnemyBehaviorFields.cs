...
[CreateAssetMenu(fileName = "AI Enemy Behavior Fields", menuName = "ScriptableObjects/AITest/AIEnemyBehaviorFields")]
public class AIEnemyBehaviorFields : ScriptableObject
{
